...
sudo echo "NEW_USERNAME=$NEW_USERNAME" | sudo tee --append /etc/piadvanced/userchange.conf
sudo echo "CHANGED_USERNAME=yes" | sudo tee --append /etc/piadvanced/userchange.conf
fi }
